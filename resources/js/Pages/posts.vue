                                ...
                                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput2" v-model="form.price" placeholder="Enter Price"></textarea>
                                            <div v-if="$page.errors.price" class="text-red-500">{{ $page.errors.price[0] }}</div>
                                        </div>
                                        <div class="mb-4">
                                            <label for="exampleFormControlInput3" class="block text-gray-700 text-sm font-bold mb-2">Discount:</label>
                                            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput3" v-model="form.discount" placeholder="Enter Discount"></textarea>
                                            <div v-if="$page.errors.discount" class="text-red-500">{{ $page.errors.discount[0] }}</div>
                                        </div>
                                        <div class="mb-4">
