        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex" v-if="!$page.user.is_customer">
                        <jet-nav-link href="/products" :active="$page.currentRouteName == 'products.index'">
                            Products
                        </jet-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex" v-if="$page.user.is_customer">
                        <jet-nav-link href="/product-list" :active="$page.currentRouteName == 'product.list'">
                            Product List
                        </jet-nav-link>
                    </div>
                </div>
